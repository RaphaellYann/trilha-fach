  ...
  return (
    <div className="max-w-4xl mx-auto py-10 px-4">
      ...
      <div className="bg-white border border-[var(--border)] p-6 rounded-lg shadow-sm mb-10">
        <h2 className="font-bold text-[var(--text)] mb-4 uppercase text-xs tracking-widest">
          Cadastrar Novo Usuário
        </h2>
        
        {/* Ajuste técnico: O 'wrapper' async (formData) resolve o conflito de tipos do TS */}
        <form 
        ...
        >
          <input 
            ...
            className="border p-2 rounded text-sm outline-none focus:border-[var(--primary)]" 
            required 
          />
          <input 
            name="email" 
          ...
          <button 
            type="submit" 
            className="md:col-span-2 bg-[var(--primary)] text-white font-bold py-2 rounded uppercase text-xs tracking-widest hover:opacity-90 transition-opacity"
          >
            Criar Usuário
          </button>
        </form>
